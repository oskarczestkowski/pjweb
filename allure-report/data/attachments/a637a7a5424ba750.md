...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e546]:
      - img "image" [ref=e547]
      - heading "Upgrade to Cheddar Cheese Stuffed Crust for £2.99" [level=3] [ref=e548]
      - paragraph [ref=e549]: Cheese lover? Upgrade to a Cheddar Cheese Stuffed Crust today for the ultimate cheese experience!
      - generic [ref=e550]:
        - button "Yes, please!" [ref=e551] [cursor=pointer]
        - button "No, thanks" [ref=e552] [cursor=pointer]
  - text:             􏠘
  - text:                                                                                             
```